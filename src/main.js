document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelector(".cart-buttons button:nth-child(2)").addEventListener("click", clearCart);
  document.querySelector(".cart-buttons button:first-child").addEventListener("click", openCheckout);
